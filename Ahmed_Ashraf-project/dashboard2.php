  ...
  <div class="main">
    <div class="sidebar">
      <ul>
        ...
        <li><a href="orders.php" target="frame"><i class="lni lni-bar-chart" ></i><span>orders</span></a></li>
        <li><a href="stat.php" target="frame"><i class="lni lni-grid" ></i><span>users</span></a></li>
        <li><a href="product%20stat.php" target="frame" ><i class="lni lni-bullhorn"></i><span>product</span></a></li>
    ...
    <div class="page-content">
        ...
        {
            echo '<h1 class="welcomeMessage">Welcome back,'.$_COOKIE['name'].'</h1>';
        }
        ?>
        <iframe name="frame" class="bg-frame" style="border: none; width: 100%; height: 100%;">
